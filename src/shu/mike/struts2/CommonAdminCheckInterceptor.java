...
public class CommonAdminCheckInterceptor implements Interceptor
{
	...
	public String intercept(ActionInvocation invocation) throws Exception {
		System.out.println("common  admin check....");
		...
		else
		{
			...
			String roleID=rd.getRoleID(RoleDefinition.COMMON_ADMIN);
